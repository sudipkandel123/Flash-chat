...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        FirebaseApp.configure() //to configure the firebase
        //let myDatabase = Database.database().reference() //get the reference of the firebase database to the root of the database() and converts to the database
